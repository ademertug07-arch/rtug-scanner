"""
BIST Tum Hisse Senetleri (Yahoo Finance)
=========================================
Yahoo Finance'de .IS uzantisi ile islem goren tum BIST hisseleri.
Yaklasik 613 hisse + ETF'ler.

Kullanim:
    from bist_symbols import BIST_ALL, BIST_SYMBOLS
"""

# Ana hisseler (~500 adet)
BIST_SYMBOLS = [
    ...
    "KTLEV", "KTSKR", "KUTPO", "KUVVA", "KUYAS", "KZBGY", "KZGYO", "LIDER",
    "LIDFA", "LILAK", "LINK", "LKMNH", "LMKDC", "LOGO", "LRSHO", "LUKSK",
    "LXGYO", "LYDHO", "LYDYE", "MAALT", "MACKO", "MAGEN", "MAKIM", "MAKTK",
    "MANAS", "MARBL", "MARKA", "MARMR", "MARTI", "MAVI", "MCARD", "MEDTR",
    "MEGAP", "MEGMT", "MEKAG", "MEPET", "MERCN", "MERIT", "MERKO", "METRO",
    "MEYSU", "MGROS", "MHRGY", "MIATK", "MMCAS", "MNDRS", "MNDTR", "MOBTL",
    "MOGAN", "MOPAS", "MPARK", "MRGYO", "MRSHL", "MSGYO", "MTRKS", "MTRYO",
    "MZHLD", "NATEN", "NETAS", "NETCD", "NIBAS", "NPTLR", "NTGAZ", "NTHOL",
    "NUGYO", "NUHCM", "OBAMS", "OBASE", "ODAS", "ODINE", "OFSYM", "ONCSM",
    "ONRYT", "ORCAY", "ORGE", "ORMA", "OSMEN", "OSTIM", "OTKAR", "OTTO",
    "OYAKC", "OYAYO", "OYLUM", "OYYAT", "OZATD", "OZGYO", "OZKGY", "OZRDN",
    "OZSUB", "OZYSR", "PAGYO", "PAHOL", "PAMEL", "PAPIL", "PARSN", "PASEU",
    ...
    "SEKFK", "SEKUR", "SELEC", "SEYKM", "SILVR", "SISE", "SKBNK", "SKTAS",
    "SKYLP", "SMART", "SMRTG", "SNGYO", "SNICA", "SNKRN", "SNPAM", "SOKM",
    "SONME", "SORTE", "SPORT", "SRVGY", "SSKBN", "STARH", "STDGY", "STFTT",
    "SUDEN", "SUKGY", "SUNTK", "SURHL", "SUVGY", "TABGD", "TAVHL", "TCELL",
    "TDGYO", "TEKST", "TEKTU", "TERA", "TGSAS", "THYAO", "TIBMA", "TKFEN",
    "TKNSA", "TMPOL", "TMSN", "TMXTR", "TOASO", "TRCAS", "TRILC", "TSKCB",
    "TSKRS", "TSPOR", "TTKOM", "TTRAK", "TUCLK", "TUKAS", "TUPRS", "TUREX",
    "TURGG", "TURKL", "TUTAP", "UFUK", "UKGYO", "ULAS", "ULKER", "ULUFA",
    "ULUSE", "UMPAS", "UNBIS", "UNLMA", "UNLU", "UNTAR", "URAN", "URCEK",
    "USAK", "UYUM", "UZERB", "VAKBN", "VAKFN", "VANGD", "VBTSY", "VERTU",
    "VESBE", "VESTL", "VKGYO", "VRGYO", "YAPRK", "YATAS", "YAYLA", "YAZIC",
    "YBTAS", "YEGYO", "YEOTK", "YESIL", "YETMG", "YGGYO", "YIGIT", "YONGA",
    "YUNSA", "YYAPI", "ZEDUR", "ZOREN",
]

# Tum BIST (hisseler + ETF'ler + endeksler)
BIST_ALL = BIST_SYMBOLS + [
    # BIST ETF'leri ve Yatirim Fonlari
...
# Sadece hisseler (ETF'ler ve endeksler haric)
BIST_STOCKS_ONLY = BIST_SYMBOLS
